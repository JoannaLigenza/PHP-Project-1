    ...
    <div class="card text-center py-5" style="background-color: #F7F7F7">
        ...
        <div class="card-body py-5" style="background-color: #F7F7F7">
            ...
            <form action="" method="post" id="signin-form">
                <input type="text" placeholder="username" name="username" class="container form-control form-control-lg" id="username " autofocus>
                ...
                <input type="email" placeholder="e-mail:" name="email" class="container form-control form-control-lg" id="email" >
                <label for="email" class="container-fluid text-left text-muted"><small>Needed to confirm registration</small></label>

                <input type="password" placeholder="password:" name="pass" class="container form-control form-control-lg" id="pass" >
                ...
                <button type="submit" name="signin-button" class="container btn btn-outline-warning my-2 py-2" id="sign-in-button">Sign In</button>
            </form>
        </div>
    </div>
</div>
